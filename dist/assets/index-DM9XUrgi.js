...
`,g=`import { THREE, ThreeEditor } from '/three-editor/dist/js/index.js'
...
`,h=`import { Cesium, CesiumEditor } from '/three-editor/dist/cesium/index.js'
...
`,w=`import { Cesium, CesiumEditor } from '/three-editor/dist/cesium/index.js'
...
// 使用封装类简化创建cesium代码
const { viewer } = new CesiumEditor({ DOM: document.getElementById('box')})
...
`,p=`import { Cesium, Supercluster, CesiumEditor } from '/three-editor/dist/cesium/index.js' // 自行引入依赖
...
`,T=`import { Cesium, CesiumEditor } from '/three-editor/dist/cesium/index.js'
