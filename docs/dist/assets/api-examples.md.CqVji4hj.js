import{u as i,c as a,a0 as n,o as l}from"./chunks/framework.D_N85Agi.js";const e=JSON.parse('{"title":"创建一个场景","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"api-examples.md","filePath":"api-examples.md"}'),p={name:"api-examples.md"},r=Object.assign(p,{setup(h){return i(),(t,s)=>(l(),a("div",null,s[0]||(s[0]=[n(`<h1 id="创建一个场景" tabindex="-1">创建一个场景 <a class="header-anchor" href="#创建一个场景" aria-label="Permalink to &quot;创建一个场景&quot;">​</a></h1><div class="language-md vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;script&gt;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">chartsMapCore.progressList </span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// [promise] 列表 promise.then 返回地图对应的group 对象</span></span></code></pre></div>`,20)])))}});export{e as __pageData,r as default};
