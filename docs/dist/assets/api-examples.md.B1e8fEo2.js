import{u as i,c as a,o as n,ae as l}from"./chunks/framework.TG5E9i2h.js";const g=JSON.parse('{"title":"创建一个场景","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"api-examples.md","filePath":"api-examples.md"}'),p={name:"api-examples.md"},y=Object.assign(p,{setup(h){const{site:t,theme:k,page:e,frontmatter:r}=i();return(d,s)=>(n(),a("div",null,s[0]||(s[0]=[l(`<h1 id="创建一个场景" tabindex="-1">创建一个场景 <a class="header-anchor" href="#创建一个场景" aria-label="Permalink to &quot;创建一个场景&quot;">​</a></h1><div class="language-md vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;script&gt;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    </span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">const container =  document.querySelector(&#39;#threeBox&#39;)</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">const initParams = {</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    fps: null, // 最大帧率</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    pixelRatio: window.devicePixelRatio, //像素比</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    webglRenderParams: { antialias: true, alpha: true, logarithmicDepthBuffer: true } // 抗锯齿等</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    sceneParams</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">const threeEditor = new ThreeEditor(containor, initParams)</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;/script&gt;</span></span></code></pre></div><h3 id="通用引入形式-api-或-对象" tabindex="-1">通用引入形式 API 或 对象 <a class="header-anchor" href="#通用引入形式-api-或-对象" aria-label="Permalink to &quot;通用引入形式 API 或 对象&quot;">​</a></h3><ul><li>使用方式 import { API } from &#39;源&#39;</li></ul><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">chartsMapCore.progressList </span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// [promise] 列表 promise.then 返回地图对应的group 对象</span></span></code></pre></div>`,20)])))}});export{g as __pageData,y as default};
